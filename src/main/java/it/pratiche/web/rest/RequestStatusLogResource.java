...
import it.pratiche.web.rest.errors.BadRequestAlertException;
import it.pratiche.web.rest.util.HeaderUtil;
...
public class RequestStatusLogResource {
    ...
    public RequestStatusLogResource(RequestStatusLogRepository requestStatusLogRepository) {
    ...
    public ResponseEntity<RequestStatusLog> createRequestStatusLog(@Valid @RequestBody RequestStatusLog requestStatusLog) throws URISyntaxException {
        ...
        RequestStatusLog result = requestStatusLogRepository.save(requestStatusLog);
    ...
    public ResponseEntity<RequestStatusLog> getRequestStatusLog(@PathVariable Long id) {
        ...
        RequestStatusLog requestStatusLog = requestStatusLogRepository.findOne(id);
