...
import it.pratiche.repository.DocStoreRepository;
...
import it.pratiche.domain.enumeration.LocaleEnum;
/**
...
public class DocStoreResourceIntTest {
    ...
    public void setup() {
        ...
        final DocStoreResource docStoreResource = new DocStoreResource(docStoreRepository);
