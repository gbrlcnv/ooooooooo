package it.pratiche.web.rest;

import it.pratiche.config.Constants;
import it.pratiche.OooooooooApp;
import it.pratiche.domain.Authority;
import it.pratiche.domain.User;
import it.pratiche.repository.AuthorityRepository;
import it.pratiche.repository.UserRepository;
import it.pratiche.security.AuthoritiesConstants;
import it.pratiche.service.MailService;
import it.pratiche.service.dto.UserDTO;
import it.pratiche.web.rest.errors.ExceptionTranslator;
import it.pratiche.web.rest.vm.KeyAndPasswordVM;
import it.pratiche.web.rest.vm.ManagedUserVM;
import it.pratiche.service.UserService;
...
@SpringBootTest(classes = OooooooooApp.class)
