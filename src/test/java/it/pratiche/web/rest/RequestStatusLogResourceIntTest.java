...
import it.pratiche.repository.RequestStatusLogRepository;
...
public class RequestStatusLogResourceIntTest {
    ...
    public void setup() {
        ...
        final RequestStatusLogResource requestStatusLogResource = new RequestStatusLogResource(requestStatusLogRepository);
