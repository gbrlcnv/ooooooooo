...
import it.pratiche.repository.RequestStatusRepository;
...
public class RequestStatusResourceIntTest {
    ...
    public void setup() {
        ...
        final RequestStatusResource requestStatusResource = new RequestStatusResource(requestStatusRepository);
